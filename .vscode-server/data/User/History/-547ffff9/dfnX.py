...
def home():
    ...
    <html>
        ...
        <body>
            <h1>Welcome to the CRUD Web Service</h1>
            <p>Developed by: 엄윤상</p>
            <h2>Available Features:</h2>
            <ul>
                <li><a href="/courses/add">Add Course</a></li>
                <li><a href="/courses">View Courses</a></li>
                <li><a href="/courses/update">Update Course</a></li>
                <li><a href="/courses/delete">Delete Course</a></li>
            </ul>
        </body>
    </html>
    """
